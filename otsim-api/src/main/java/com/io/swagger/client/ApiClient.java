...
import com.io.swagger.client.auth.ApiKeyAuth;
import com.io.swagger.client.auth.Authentication;
import com.io.swagger.client.auth.HttpBasicAuth;
import com.io.swagger.client.auth.OAuth;
...
public class ApiClient {
	...
	private String basePath = "http://10.0.8.210:3000/api/v1";
	...
	public ApiClient() {
		...
		// Always use UTC as the default time zone when dealing with date (without
		// time).
		...
		authentications.put("authToken", new ApiKeyAuth("header", "X-Auth-Token"));
		authentications.put("userId", new ApiKeyAuth("header", "X-User-Id"));
	...
	public ApiClient setAuthToken(String token) {
		...
		((ApiKeyAuth) authentications.get("authToken")).setApiKey(token);
		return this;
	}

	public ApiClient setUserId(String userId) {

		((ApiKeyAuth) authentications.get("userId")).setApiKey(userId);
		return this;
	}
	 ...
	 *
	 * @param basePath
	 *            Base path of the URL (e.g http://10.0.8.210/api/v1
	...
	/**
	 * Parse the given datetime string into Date object. When lenientDatetimeFormat
	 * is enabled, the following ISO 8601 datetime formats are supported:
	 * 2015-08-16T08:20:05Z 2015-8-16T8:20:05Z 2015-08-16T08:20:05+00:00
	 * 2015-08-16T08:20:05+0000 2015-08-16T08:20:05.376Z
	 * 2015-08-16T08:20:05.376+00:00 2015-08-16T08:20:05.376+00 Note: The 3-digit
	 * milli-seconds is optional. Time zone is required and can be in one of these
	 * formats: Z (same with +0000) +08:00 (same with +0800) -02 (same with -0200)
	 * -0200
	 * 
